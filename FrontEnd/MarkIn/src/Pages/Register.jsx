        ...
        <div>
          ...
          <div className="relative mt-5">
            ...
            <input
              ...
              name="name"
              value={values.name}
              className={`w-full rounded-sm border p-3 pl-10 text-lg focus:outline-none focus:ring-2 focus:ring-indigo-400 ${errors.name && touched.name ? "border-red-500" : "border-gray-300"}`}
          ...
          <div className="relative mt-5">
            ...
            <input
              ...
              name="email"
              value={values.email}
              className={`w-full rounded-sm border p-3 pl-10 text-lg focus:outline-none focus:ring-2 focus:ring-indigo-400 ${errors.email && touched.email ? "border-red-500" : "border-gray-300"}`}
              onChange={handleChange}
              onBlur={handleBlur}
            />{" "}
          </div>{" "}
          <div className="relative mt-5">
            ...
            <input
              ...
              className={`w-full rounded-sm border p-3 pl-10 text-lg focus:outline-none focus:ring-2 focus:ring-indigo-400 ${errors.password && touched.password ? "border-red-500" : "border-gray-300"}`}
              onChange={handleChange}
              onBlur={handleBlur}
            />{" "}
          </div>{" "}
          <div className="relative mt-5">
            ...
            <input
              ...
              className={`w-full rounded-sm border p-3 pl-10 text-lg focus:outline-none focus:ring-2 focus:ring-indigo-400 ${errors.confirm_password && touched.confirm_password ? "border-red-500" : "border-gray-300"}`}
              onChange={handleChange}
              onBlur={handleBlur}
            />{" "}
          </div>{" "}
